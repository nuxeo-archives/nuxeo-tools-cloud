...
default["launcher"]["url"] = "http://maven.in.nuxeo.com/nexus/service/local/artifact/maven/redirect?r=internal-snapshots&g=org.nuxeo&a=nuxeo-launcher&v=5.6-SNAPSHOT&e=jar&c=jar-with-dependencies"
default["resources"]["url"] = "http://maven.in.nuxeo.com/nexus/service/local/artifact/maven/redirect?r=internal-snapshots&g=org.nuxeo.ecm.distribution&a=nuxeo-distribution-resources&v=5.6-SNAPSHOT&e=zip&c=bin"
